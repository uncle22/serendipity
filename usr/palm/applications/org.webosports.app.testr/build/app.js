...
enyo.path.addPaths({layout: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.testr/0.1.0+gitrAUTOINC+fd156a1dbd81dff8930760139afdfb5b8c9b6989-r0/git/enyo/../lib/layout/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.testr/0.1.0+gitrAUTOINC+fd156a1dbd81dff8930760139afdfb5b8c9b6989-r0/git/enyo/../lib/onyx/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.testr/0.1.0+gitrAUTOINC+fd156a1dbd81dff8930760139afdfb5b8c9b6989-r0/git/enyo/../lib/onyx/source/"});
...
openHtml5Audio: function(e) {
this.$.ContentPanels.setIndex(2), enyo.Panels.isScreenNarrow() && this.setIndex(2);
}
}), enyo.kind({
name: "App",
layoutKind: "FittableRowsLayout",
...
srcChanged: function() {
var e = enyo.path.rewrite(this.src);
this.setAttribute("src", e), this.setAttribute("type", "audio/wav");
},
preloadChanged: function() {
this.setAttribute("autobuffer", this.preload ? "autobuffer" : null), this.setAttribute("preload", this.preload ? "preload" : null);
},
play: function() {
...
components: [ {
content: "Clicking the button below will play a alarm audio sound to verify that HTML 5 Audio support is working correctly. If you don't hear anything the test has failed.",
