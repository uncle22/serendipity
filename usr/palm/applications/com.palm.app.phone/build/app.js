...
enyo.path.addPaths({layout: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.phone/0.1.0+gitrAUTOINC+6b959f3749de0ed41f7e01bfc83e67adc8bf6207-r0/git/enyo/../lib/layout/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.phone/0.1.0+gitrAUTOINC+6b959f3749de0ed41f7e01bfc83e67adc8bf6207-r0/git/enyo/../lib/onyx/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.phone/0.1.0+gitrAUTOINC+6b959f3749de0ed41f7e01bfc83e67adc8bf6207-r0/git/enyo/../lib/onyx/source/"});
...
var parseUrlArgs = function(e) {
var t = e.split("&"), n = {};
for (var r = 0, i, s; i = t[r]; r++) s = t[r] = i.split("="), n[s[0]] = s.length > 1 ? s[1] : !0;
return n;
};
...
create: function() {
this.inherited(arguments), this.$.Content.setContent(this.content);
}
}), enyo.kind({
name: "AppPanels",
kind: "Panels",
...
create: function() {
this.inherited(arguments), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
reflow: function() {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? (this.$.Contacts.applyStyle("width", "100%"), this.$.Dialpad.applyStyle("width", "100%"), this.$.History.applyStyle("width", "100%"), this.setIndex(1), this.setDraggable(!0)) : (this.$.Contacts.applyStyle("width", "33%"), this.$.Dialpad.applyStyle("width", "34%"), this.$.History.applyStyle("width", "33%"), this.setIndex(0), this.setDraggable(!1));
},
keyTapped: function(e, t) {
var n = this.$.NumberInput;
n.setContent(n.getContent() + e.getContent());
},
deleteTapped: function(e, t) {
var n = this.$.NumberInput;
n.setContent(n.getContent().substr(0, n.getContent().length - 1));
}
}), enyo.kind({
name: "PhoneApp",
layoutKind: "FittableRowsLayout",
...
enyo.Panels.isScreenNarrow() && this.$.AppPanels.dragstartTransition(t);
},
handleCoreNaviDrag: function(e, t) {
enyo.Panels.isScreenNarrow() && this.$.AppPanels.dragTransition(t);
},
handleCoreNaviDragFinish: function(e, t) {
enyo.Panels.isScreenNarrow() && this.$.AppPanels.dragfinishTransition(t);
},
