...
enyo.path.addPaths({layout: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.firstuse/0.2.0+gitrAUTOINC+35825a101aebfc912f9102e758ab6c5f7e9f66f7-r0/git/enyo/../lib/layout/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.firstuse/0.2.0+gitrAUTOINC+35825a101aebfc912f9102e758ab6c5f7e9f66f7-r0/git/enyo/../lib/onyx/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.firstuse/0.2.0+gitrAUTOINC+35825a101aebfc912f9102e758ab6c5f7e9f66f7-r0/git/enyo/../lib/onyx/source/", ports: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.firstuse/0.2.0+gitrAUTOINC+35825a101aebfc912f9102e758ab6c5f7e9f66f7-r0/git/enyo/../lib/ports/", ports: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.firstuse/0.2.0+gitrAUTOINC+35825a101aebfc912f9102e758ab6c5f7e9f66f7-r0/git/enyo/../lib/ports/source/"});
...
if (t) for (var o in e) i = e[o], s = t[o], i != s && (r[o] = (i - (i - s) * n).toFixed(20));
return r;
}
}
});
...
style: "position: absolute; right: 8px; width: 32px; max-width: 100%; margin: 5px; float: right",
components: [ {
name: "SearchInput",
id: "searchBox",
kind: "onyx.Input",
...
this.$.SearchInput.applyStyle("width", this.hasNode().offsetWidth * e.value - 64 + "px"), this.$.SearchDecorator.applyStyle("width", this.$.SearchInput.hasNode().offsetWidth + 32 + "px"), this.$.Icon.applyStyle("opacity", 1 - e.value), this.$.TextDiv.applyStyle("opacity", 1 - e.value), this.$.SearchAnimator.getStartValue() == 0 && this.$.SearchInput.focus();
},
...
licenseContent = "Open webOS (Ports) is released for free non-commercial use. It is provided without warranty, even the implied warranty of merchantability, satisfaction or fitness for a particular use. See the licence included with each program for details.<br><br>Some licences may grant additional rights; this notice shall not limit your rights under each program's licence. Licences for each program are available in the /usr/share/licenses directory. Source code for Open webOS (Ports) can be downloaded from http://github.com/openwebos and http://github.com/webOS-ports.<br><br>Open webOS (Ports) is released for limited use due to the inclusion of binary hardware support files. The original components and licenses can be found at:<br><br>https://developers.google.com/android/nexus/drivers ";
...
title: "License",
style: "height: 42px;",
taglines: [ "You're definitely going to read this, right?", "Lots of text!", "FOSS!", "Scroll scroll scroll scroll tap.", "Will you take the red pill, or the green pill?" ]
}, {
...
tag: "div",
style: "margin: 8px 8% 0 8%; padding: 0; line-height: 42px;",
layoutKind: "FittableColumnsLayout",
components: [ {
name: "DeclineButton",
kind: "onyx.Button",
...
this.inherited(arguments), this.$.OpacityAnimator.setStartValue(0), this.$.OpacityAnimator.setEndValue(1);
var n = this;
setTimeout(function() {
n.$.OpacityAnimator.play();
}, 1e3);
},
acceptLicense: function(e, t) {
this.licenseAccepted = !0, this.$.DeclineButton.setDisabled(!0), this.$.AcceptButton.setDisabled(!0), this.$.OpacityAnimator.setStartValue(1), this.$.OpacityAnimator.setEndValue(0);
var n = this;
setTimeout(function() {
n.$.OpacityAnimator.play();
}, 1e3);
},
declineLicense: function(e, t) {
this.$.DeclineButton.setDisabled(!0), this.$.AcceptButton.setDisabled(!0), this.$.OpacityAnimator.setStartValue(1), this.$.OpacityAnimator.setEndValue(0);
var n = this;
setTimeout(function() {
n.$.OpacityAnimator.play();
}, 1e3);
...
animatorStep: function(e, t) {
enyo.Arranger.opacifyControl(this, e.value), this.addStyles("-webkit-transform: scale3d(" + (e.value / 2 + .5) + "," + (e.value / 2 + .5) + ",0);");
},
animatorEnd: function(e, t) {
if (this.$.OpacityAnimator.endValue == 0) if (this.licenseAccepted == 1) PalmSystem.markFirstUseDone(), PalmSystem.shutdown(); else var n = navigator.service.Request("luna://com.palm.power/shutdown/", {
method: "machineOff",
parameters: {
reason: "First Use Declined."
}
}); else this.addStyles("-webkit-transform: scale3d();");
}
});
