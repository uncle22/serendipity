...
enyo.path.addPaths({layout: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.memos/1.0.6+gitrAUTOINC+86c4e33ff7e51e80845fb564ba0e0ea99cae818d-r1/git/enyo/../lib/layout/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.memos/1.0.6+gitrAUTOINC+86c4e33ff7e51e80845fb564ba0e0ea99cae818d-r1/git/enyo/../lib/onyx/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.memos/1.0.6+gitrAUTOINC+86c4e33ff7e51e80845fb564ba0e0ea99cae818d-r1/git/enyo/../lib/onyx/source/"});
...
(t.keyIdentifier == "U+1200001" || t.keyIdentifier == "U+001B") && this.doBack(t);
}
});
...
clicked: function() {
this.doChanged({
value: this.active.hasNode().style.backgroundColor
});
}
}), enyo.kind({
name: "ContentPanel",
...
reflow: function(e) {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? this.$.Grabber.applyStyle("visibility", "hidden") : this.$.Grabber.applyStyle("visibility", "shown");
},
inputChanged: function(e) {
this.doTitleChanged({
index: this.container.index,
value: this.$.TitleInput.getValue()
});
},
colorChanged: function(e, t) {
this.$.ContentScroller.addStyles("background-color: " + t.value + ";"), this.doColourChanged({
index: this.container.index,
value: t.value
});
},
memoChanged: function(e) {
this.doMemoChanged({
index: this.container.index,
value: this.$.MemoText.getValue()
});
}
}), enyo.kind({
name: "EmptyPanel",
...
var storageObject = {}, searchResults = {};
...
taglines: [ "Memo-tastic!", "(Better than Notes)", "Random taglines are still awesome.", "Not as sticky as you'd think.", "Pastel colours. Mmm.", "Now with 100% more sliding!", "Exactly what is says on the tin.", "Skeumorphism is so 2009." ]
}, {
kind: "Scroller",
horizontal: "hidden",
classes: "enyo-fill",
...
rendered: function(e) {
this.inherited(arguments), this.loadMemos();
},
reflow: function(e) {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? (this.setArrangerKind("PushPopArranger"), this.setDraggable(!1), this.$.ContentPanels.addStyles("box-shadow: 0")) : (this.setArrangerKind("CollapsingArranger"), this.setDraggable(!0), this.$.ContentPanels.addStyles("box-shadow: -4px 0px 4px rgba(0,0,0,0.3)"));
},
...
saveMemos: function() {
storageObject = {};
var e = this.$.ContentPanels.getPanels();
idx = 0;
for (var t in e) e[t].kind == "ContentPanel" && (storageObject[idx] = {}, storageObject[idx].title = e[t].$.TitleInput.getValue(), storageObject[idx].colour = e[t].$.ContentScroller.hasNode().style.backgroundColor, storageObject[idx].text = e[t].$.MemoText.getValue(), idx++);
localStorage.webOSMemos = JSON.stringify(storageObject);
},
loadMemos: function() {
var e = this.$.ContentPanels.getPanels();
for (var t in e) e[t].kind == "ContentPanel" && e[t].destroy();
this.$.MenuRepeater.setCount(0);
if (localStorage.webOSMemos) {
storageObject = JSON.parse(localStorage.webOSMemos);
var n = 0;
for (var r in storageObject) p = this.createPanel(), p.$.TitleInput.setValue(storageObject[r].title), p.$.ContentScroller.addStyles("background-color: " + storageObject[r].colour + "!important;"), p.$.MemoText.setValue(storageObject[r].text), p.render(), n++;
this.$.ContentPanels.reflow(), this.$.MenuRepeater.setCount(n);
}
this.$.MenuRepeater.count == 0 ? (this.draggable = !1, this.$.ContentPanels.setIndex(0)) : (this.draggable = !0, this.$.ContentPanels.setIndex(2));
},
createPanel: function(e) {
var t = this.$.ContentPanels;
...
setupMenuItem: function(e, t) {
var n = this.$.ContentPanels.getPanels();
return enyo.log(this.$.MenuHeader.searchActive()), n[t.index + 1] && !this.$.MenuHeader.searchActive() ? (t.item.controls[0].controls[0].setContent(n[t.index + 1].$.TitleInput.getValue()), t.item.controls[0].controls[1].addStyles("background-color: " + n[t.index + 1].$.ContentScroller.hasNode().style.backgroundColor + "!important;")) : searchResults[t.index] && (t.item.controls[0].controls[0].setContent(searchResults[t.index].title), t.item.controls[0].controls[1].addStyles("background-color: " + searchResults[t.index].colour + "!important;")), !0;
},
newMemo: function(e, t) {
var n = 0;
for (idx in storageObject) n++;
p = this.createPanel(), p.render(), this.$.ContentPanels.reflow();
var r = this.$.ContentPanels;
r.setIndex(r.getPanels().length), enyo.Panels.isScreenNarrow() && this.setIndex(1), storageObject[n++] = {
title: "",
colour: "",
text: ""
}, this.$.MenuRepeater.setCount(n), this.saveMemos(), this.draggable = !0;
},
deleteMemo: function(e) {
delete storageObject[this.$.ContentPanels.getActive().index], this.$.ContentPanels.getActive().gc = !0, this.$.ContentPanels.setIndex(0);
},
gcPanels: function(e, t) {
var n = this.$.ContentPanels.getPanels()[t.fromIndex];
n && n.kind == "ContentPanel" && n.getGc() && (n.destroy(), this.$.MenuRepeater.setCount(this.$.ContentPanels.getPanels().length - 1), this.saveMemos(), this.$.MenuRepeater.count == 0 && (this.draggable = !1), this.setIndex(0));
},
panelTitleChanged: function(e, t) {
this.$.MenuRepeater.renderRow(t.index - 1), this.saveMemos();
},
panelColourChanged: function(e, t) {
this.$.MenuRepeater.renderRow(t.index - 1), this.saveMemos();
},
memoChanged: function(e, t) {
this.saveMemos();
},
menuItemTapped: function(e, t) {
if (!this.$.MenuHeader.searchActive()) this.$.ContentPanels.setIndex(t.index + 1); else {
var n = this.$.ContentPanels.getPanels(), r = 0;
for (var i in n) {
if (n[i].kind == "ContentPanel" && searchResults[t.index].title == n[i].$.TitleInput.getValue()) {
this.$.ContentPanels.setIndex(r);
break;
}
r++;
}
}
enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
searchMemos: function(e, t) {
searchResults = {};
var n = this.$.MenuRepeater, r = this.$.ContentPanels.getPanels(), i = 0;
for (var s in r) r[s].kind == "ContentPanel" && r[s].$.TitleInput.getValue().match(t.value) && (searchResults[i] = {
title: r[s].$.TitleInput.getValue(),
colour: r[s].$.ContentScroller.hasNode().style.backgroundColor
}, i++);
n.setCount(i);
}
});
