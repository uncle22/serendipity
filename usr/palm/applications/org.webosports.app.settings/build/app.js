...
enyo.path.addPaths({layout: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.settings/0.3.0+gitrAUTOINC+efc30a1b4cbc99242aef72ea66ec7a3fe676f0ef-r1/git/enyo/../lib/layout/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.settings/0.3.0+gitrAUTOINC+efc30a1b4cbc99242aef72ea66ec7a3fe676f0ef-r1/git/enyo/../lib/onyx/", onyx: "/home/jenkins/webos-ports/workspace/webos-ports/tmp-eglibc/work/all-webos-linux/org.webosports.app.settings/0.3.0+gitrAUTOINC+efc30a1b4cbc99242aef72ea66ec7a3fe676f0ef-r1/git/enyo/../lib/onyx/source/"});
...
appChanged: function() {
this.appPath = "";
if (this.app) var e = navigator.service.Request("luna://com.palm.applicationManager/", {
...
create: function() {
this.inherited(arguments), this.$.ItemIcon.setSrc(this.icon), this.$.ItemTitle.setContent(this.title);
},
pressed: function() {
...
kind: "PortsHeader",
title: "Settings",
taglines: [ "Ye gods, look at all those options!", "46% more wub-wub than last year's Settings.", "For all your tinkering needs.", "Customizable? Customizable.", "E pluribus unum.", "Schmettings.", "This is where the options live, get you some!" ]
}, {
kind: "Scroller",
horizontal: "hidden",
classes: "enyo-fill",
...
name: "WiFiPanel",
kind: "WiFi",
onActiveChanged: "wifiActiveChanged"
}, {}, {}, {}, {}, {}, {
kind: "Exhibition"
}, {}, {}, {}, {
kind: "ScreenLock"
...
wifiActiveChanged: function(e, t) {
this.$.WiFiToggle.setValue(t.value);
},
wifiToggleChanged: function(e) {
this.$.WiFiPanel.setToggleValue(e.value);
},
openWiFi: function(e) {
this.$.ContentPanels.setIndex(1), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openBluetooth: function(e) {
this.$.ContentPanels.setIndex(2), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openVPN: function(e) {
this.$.ContentPanels.setIndex(3), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openAccounts: function(e) {
this.$.ContentPanels.setIndex(4), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openBackup: function(e) {
this.$.ContentPanels.setIndex(5), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openTextAssist: function(e) {
this.$.ContentPanels.setIndex(6), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openExhibition: function(e) {
this.$.ContentPanels.setIndex(7), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openSIM: function(e) {
this.$.ContentPanels.setIndex(8), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openSoftwareManager: function(e) {
this.$.ContentPanels.setIndex(9), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openSystemUpdates: function(e) {
this.$.ContentPanels.setIndex(10), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openScreenLock: function(e) {
this.$.ContentPanels.setIndex(11), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openSoundRingtones: function(e) {
this.$.ContentPanels.setIndex(12), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openDateTime: function(e) {
this.$.ContentPanels.setIndex(13), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openRegionalSettings: function(e) {
this.$.ContentPanels.setIndex(14), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openLocationServices: function(e) {
this.$.ContentPanels.setIndex(15), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openDeviceInfo: function(e) {
this.$.ContentPanels.setIndex(16), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openDevOptions: function(e) {
this.$.ContentPanels.setIndex(17), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
openTelephony: function(e) {
this.$.ContentPanels.setIndex(18), enyo.Panels.isScreenNarrow() && this.setIndex(1);
}
}), enyo.kind({
name: "App",
layoutKind: "FittableRowsLayout",
...
reflow: function(e) {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? (this.$.AppPanels.setArrangerKind("CoreNaviArranger"), this.$.AppPanels.setDraggable(!1), this.$.AppPanels.$ContentPanels.addStyles("box-shadow: 0")) : (this.$.AppPanels.setArrangerKind("CollapsingArranger"), this.$.AppPanels.setDraggable(!0), this.$.AppPanels.$.ContentPanels.addStyles("box-shadow: -4px 0px 4px rgba(0,0,0,0.3)"));
},
handleBackGesture: function(e, t) {
this.$.AppPanels.setIndex(0);
},
handleCoreNaviDragStart: function(e, t) {
this.$.AppPanels.dragstartTransition(this.$.AppPanels.draggable == 0 ? this.reverseDrag(t) : t);
},
handleCoreNaviDrag: function(e, t) {
this.$.AppPanels.dragTransition(this.$.AppPanels.draggable == 0 ? this.reverseDrag(t) : t);
},
handleCoreNaviDragFinish: function(e, t) {
this.$.AppPanels.dragfinishTransition(this.$.AppPanels.draggable == 0 ? this.reverseDrag(t) : t);
},
...
name: "NetworkTimeToggle",
kind: "onyx.ToggleButton",
disabled: !0,
style: "float: right;",
onChange: "networkTimeChanged"
} ]
}, {
classes: "group-item",
components: [ {
...
create: function(e, t) {
this.inherited(arguments), window.PalmSystem || enyo.log("Non-palm platform, service requests disabled.");
},
deviceready: function(e, t) {
this.inherited(arguments);
var n = navigator.service.Request("luna://com.palm.systemservice/", {
method: "getPreferences",
parameters: {
keys: [ "timeFormat", "timeZone", "useNetworkTime" ]
},
onSuccess: enyo.bind(this, "handleGetPreferencesResponse")
}), n = navigator.service.Request("luna://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
useNetworkTime: !1,
receiveNetworkTimeUpdates: !1
}
});
this.palm = !0;
},
reflow: function(e) {
this.inherited(arguments), enyo.Panels.isScreenNarrow() ? this.$.Grabber.applyStyle("visibility", "hidden") : this.$.Grabber.applyStyle("visibility", "visible");
},
timeFormatChanged: function(e, t) {
if (this.palm) var n = navigator.service.Request("luna://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
timeFormat: e.selected.content == "12 Hour" ? "HH12" : "HH24"
}
}); else enyo.log(e);
this.$.TimePicker.setIs24HrMode(e.selected.content != "12 Hour");
},
networkTimeChanged: function(e, t) {
if (this.palm) var n = navigator.service.Request("luna://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
useNetworkTime: e.value,
receiveNetworkTimeUpdates: e.value
}
}); else enyo.log(e.value);
},
dateTimeChanged: function(e, t) {
var n = {};
n.utc = t.value.getTime() / 1e3;
if (this.palm) var r = navigator.service.Request("luna://com.palm.systemservice/time/", {
method: "setSystemTime",
parameters: n
}), r = navigator.service.Request("luna://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
useNetworkTime: !1,
receiveNetworkTimeUpdates: !1
...
handleGetPreferencesResponse: function(e) {
e.timeFormat != undefined && this.$.TimeFormatPicker.setSelected(this.$.TimeFormatPicker.getClientControls()[e.timeFormat == "HH12" ? 0 : 1]), e.useNetworkTime != undefined && this.$.NetworkTimeToggle.setValue(e.useNetworkTime), e.timeZone != undefined;
}
});
...
startExhibitionTapped: function(e, t) {
if (window.PalmSystem) var n = navigator.service.Request("luna://com.palm.display/control/", {
method: "setState",
parameters: {
state: "dock"
}
}); else enyo.log("Starting Exhibition");
}
});
...
title: "Ice Plant",
filename: "iceplant.png"
}, {
title: "Ice Veins",
filename: "iceveins.png"
}, {
title: "Milky Way",
...
title: "Orange Sunset",
filename: "orangesunset.png"
}, {
title: "Snow Tracks",
filename: "snowtracks.png"
}, {
title: "Wyoming",
filename: "wyoming.png"
} ]
} ]
} ]
} ]
...
kind: "onyx.ToggleButton",
style: "float: right;",
onChange: "blinkNotificationsChanged"
}, {
kind: "onyx.Tooltip",
content: "Blinks the LED when new notifications arrive."
} ]
} ]
} ]
} ]
...
deviceready: function(e, t) {
this.inherited(arguments);
var n = navigator.service.Request("luna://com.palm.display/control/", {
method: "getProperty",
parameters: {
properties: [ "maximumBrightness", "timeout" ]
},
onSuccess: enyo.bind(this, "handleGetPropertiesResponse")
}), n = navigator.service.Request("palm://com.palm.systemservice/", {
method: "getPreferences",
parameters: {
keys: [ "showAlertsWhenLocked", "BlinkNotifications" ]
},
onSuccess: enyo.bind(this, "handleGetPreferencesResponse")
});
this.palm = !0;
...
brightnessChanged: function(e, t) {
if (this.palm) var n = navigator.service.Request("luna://com.palm.display/control/", {
method: "setProperty",
parameters: {
maximumBrightness: parseInt(this.$.BrightnessSlider.value)
}
}); else enyo.log(parseInt(this.$.BrightnessSlider.value));
},
timeoutChanged: function(e, t) {
var n;
switch (t.selected.content) {
case "30 Seconds":
n = 30;
break;
case "1 Minute":
...
if (this.palm) var r = navigator.service.Request("luna://com.palm.display/control/", {
method: "setProperty",
parameters: {
timeout: n
}
...
lockAlertsChanged: function(e, t) {
if (this.palm) var n = navigator.service.Request("palm://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
showAlertsWhenLocked: e.value
}
}); else enyo.log(e.value);
},
blinkNotificationsChanged: function(e, t) {
if (this.palm) var n = navigator.service.Request("palm://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
BlinkNotifications: e.value
}
}); else enyo.log(e.value);
},
selectedImageFile: function(e, t) {
if (t && t.length == 0) return;
var n = {
target: encodeURIComponent(t[0].fullPath)
}, r = navigator.service.Request("luna://com.palm.systemservice/wallpaper/", {
method: "importWallpaper",
parameters: n,
onSuccess: enyo.bind(this, "handleImportWallpaper")
});
},
handleGetPropertiesResponse: function(e) {
enyo.log("Handling Get Properties Response"), enyo.log(JSON.stringify(e)), e.maximumBrightness != undefined && this.$.BrightnessSlider.setValue(e.maximumBrightness), e.timeout != undefined && (e.timeout == 30 && this.$.TimeoutPicker.setSelected(this.$.TimeoutPicker.getClientControls()[0]), e.timeout == 60 && this.$.TimeoutPicker.setSelected(this.$.TimeoutPicker.getClientControls()[1]), e.timeout == 120 && this.$.TimeoutPicker.setSelected(this.$.TimeoutPicker.getClientControls()[2]), e.timeout == 180 && this.$.TimeoutPicker.setSelected(this.$.TimeoutPicker.getClientControls()[3]));
},
handleGetPreferencesResponse: function(e) {
e.showAlertsWhenLocked != undefined && this.$.AlertsToggle.setValue(e.showAlertsWhenLocked), e.BlinkNotifications != undefined && this.$.BlinkToggle.setValue(e.BlinkNotifications);
},
pickWallpaper: function(e) {
var t = "file:///usr/lib/luna/system/luna-systemui/images/wallpapers/", n = navigator.service.Request("luna://com.palm.systemservice/wallpaper/", {
method: "importWallpaper",
parameters: {
target: t + e.filename
},
...
handleImportWallpaper: function(e) {
if (e.wallpaper) var t = navigator.service.Request("luna://com.palm.systemservice/", {
method: "setPreferences",
parameters: {
...
deviceready: function(e, t) {
this.inherited(arguments);
var n = navigator.service.Request("luna://com.palm.wifi/", {
method: "getstatus",
onSuccess: enyo.bind(this, "handleInitWiFiConnectionStatus")
}), n = navigator.service.Request("luna://com.palm.wifi/", {
method: "getstatus",
subscribe: !0,
resubscribe: !0,
...
toggleButtonChanged: function(e, t) {
t.value == 1 ? this.activateWiFi(this) : this.deactivateWiFi(this), this.doActiveChanged(t);
},
listItemTapped: function(e, t) {
this.currentSSID = e.$.SSID.content, e.$.Padlock.content != "none" ? (this.$.PopupSSID.setContent(this.currentSSID), this.$.PasswordPopup.show()) : this.connect(this, {
ssid: e.$.SSID.content
});
},
setupSearchRow: function(e, t) {
t.item.$.wiFiListItem.$.SSID.setContent(this.foundNetworks[t.index].networkInfo.ssid), t.item.$.wiFiListItem.$.Padlock.setContent(this.foundNetworks[t.index].networkInfo.availableSecurityTypes), t.item.$.wiFiListItem.$.Signal.setContent(this.foundNetworks[t.index].networkInfo.signalBars);
},
popupShown: function(e, t) {
e.children[2].hasNode().focus();
},
passwordKeyPress: function(e, t) {
if (t.keyCode == 13) {
...
showKnown: function(e, t) {
this.$.WiFiPanels.setIndex(1);
},
setToggleValue: function(e) {
this.$.WiFiToggle.setValue(e);
},
activateWiFi: function(e, t) {
if (this.palm) var n = navigator.service.Request("luna://com.palm.wifi/", {
method: "setstate",
parameters: {
state: "enabled"
}
...
}); else this.handleFindNetworksResponse(this, this.phonyFoundNetworks);
},
connect: function(e, t) {
if (!this.palm) return;
var n = this.currentSSID, r = t.password, i = !1, s = {};
r != "" ? (enyo.log("Connecting to PSK network"), s = {
ssid: n,
security: {
securityType: "",
simpleSecurity: {
...
}) : (enyo.log("Connecting to unsecured network"), s = {
ssid: n
});
var o = navigator.service.Request("luna://com.palm.wifi/", {
method: "connect",
parameters: s,
...
this.foundNetworks = [], this.$.SearchRepeater.setCount(this.foundNetworks.length);
},
handleInitWiFiConnectionStatus: function(e) {
this.$.WiFiToggle.setValue(!0), this.$.RescanButton.setDisabled(!1);
var t = this;
setTimeout(function() {
t.rescan();
}, 2e3);
},
handleWiFiConnectionStatus: function(e) {
if (e.status == "serviceDisabled") this.$.WiFiToggle.setValue(!1), this.$.RescanButton.setDisabled(!0), this.clearFoundNetworks(); else if (e.status == "serviceEnabled") {
this.$.WiFiToggle.setValue(!0), this.$.RescanButton.setDisabled(!1);
var t = this;
setTimeout(function() {
t.rescan();
...
handleFindNetworksResponse: function(e) {
e.foundNetworks ? (this.foundNetworks = e.foundNetworks, this.$.SearchRepeater.setCount(this.foundNetworks.length)) : this.clearFoundNetworks();
},
handleConnectResponse: function(e) {}
});
...
components: [ {
kind: "Control",
content: "Enable FPS counter",
style: "display: inline-block; line-height: 32px;"
}, {
name: "FpsCounterToggle",
kind: "onyx.ToggleButton",
style: "float: right;",
onChange: "fpsCounterChanged"
} ]
} ]
} ]
} ]
...
deviceready: function(e, t) {
this.inherited(arguments), this.palm = !0;
},
fpsCounterChanged: function(e, t) {
var n = navigator.service.Request("luna://com.palm.systemmanager", {
...
kind: "onyx.ToggleButton",
style: "float: right;",
onChange: "roamingAllowedChanged"
} ]
}, {
classes: "group-item",
style: "height: 42px;",
...
deviceready: function(e, t) {
this.inherited(arguments);
var n = navigator.service.Request("luna://com.palm.wan/", {
method: "getstatus",
onSuccess: enyo.bind(this, "handleWanStatus")
});
},
handleWanStatus: function(e) {
console.log("WAN status changed: " + JSON.stringify(e));
if (e.returnValue) {
var t = !1, n = !1;
n = e.disablewan == "on", t = e.roamGuard == "enable", this.$.RoamingAllowed.setValue(t), this.$.DataUsage.setValue(n);
}
},
roamingAllowedChanged: function(e, t) {
var n = navigator.service.Request("luna://com.palm.wan/", {
method: "set",
parameters: {
roamguard: e.getValue()
}
});
},
dataUsageChanged: function(e, t) {
var n = navigator.service.Request("luna://com.palm.wan/", {
method: "set",
parameters: {
disablewan: e.getValue()
}
});
}
});
